...
#SBATCH --output=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/hcrl_sa/fusion/fusion_hcrl_sa_20260125_092420.log
#SBATCH --error=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/hcrl_sa/fusion/fusion_hcrl_sa_20260125_092420.err
...
echo "Running: python train_with_hydra_zen.py --preset=fusion_hcrl_sa --data-path /users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/data/automotive/hcrl_sa"
python train_with_hydra_zen.py --preset fusion_hcrl_sa --data-path /users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/data/automotive/hcrl_sa
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "Check logs: /users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/hcrl_sa/fusion/fusion_hcrl_sa_20260125_092420.err"
    exit $EXIT_CODE
fi
