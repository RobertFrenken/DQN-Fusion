...
#SBATCH --output=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/hcrl_sa/autoencoder/autoencoder_hcrl_sa_20260125_085729.log
#SBATCH --error=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/hcrl_sa/autoencoder/autoencoder_hcrl_sa_20260125_085729.err
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "Check logs: /users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/hcrl_sa/autoencoder/autoencoder_hcrl_sa_20260125_085729.err"
    exit $EXIT_CODE
fi
