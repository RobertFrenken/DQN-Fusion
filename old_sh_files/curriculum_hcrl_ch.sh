...
#SBATCH --output=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/hcrl_ch/curriculum_hcrl_ch_20260125_093002.log
#SBATCH --error=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/hcrl_ch/curriculum_hcrl_ch_20260125_093002.err
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "Check logs: /users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/hcrl_ch/curriculum_hcrl_ch_20260125_093002.err"
    exit $EXIT_CODE
fi
