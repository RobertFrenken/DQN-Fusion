...
#SBATCH --output=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/set_01/autoencoder/autoencoder_set_01_2026-01-25_14-23-51.log
#SBATCH --error=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/set_01/autoencoder/autoencoder_set_01_2026-01-25_14-23-51.err
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "Check logs: /users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/set_01/autoencoder/autoencoder_set_01_2026-01-25_14-23-51.err"
    exit $EXIT_CODE
fi
