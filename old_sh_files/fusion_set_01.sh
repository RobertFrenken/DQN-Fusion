...
#SBATCH --output=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/set_01/fusion/fusion_set_01_20260125_093013.log
#SBATCH --error=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/set_01/fusion/fusion_set_01_20260125_093013.err
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "Check logs: /users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/set_01/fusion/fusion_set_01_20260125_093013.err"
    exit $EXIT_CODE
fi
