#!/bin/bash
#SBATCH --job-name=automotive_hcrlch_unsupervised_vgae_teacher_no_all
...
#SBATCH --output=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/hcrl_ch/vgae/teacher/no-kd/autoencoder/vgae_teacher_autoencoder_hcrl_ch_2026-01-25_14-23-34.log
#SBATCH --error=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/hcrl_ch/vgae/teacher/no-kd/autoencoder/vgae_teacher_autoencoder_hcrl_ch_2026-01-25_14-23-34.err
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "Check logs: /users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/hcrl_ch/vgae/teacher/no-kd/autoencoder/vgae_teacher_autoencoder_hcrl_ch_2026-01-25_14-23-34.err"
    exit $EXIT_CODE
fi
