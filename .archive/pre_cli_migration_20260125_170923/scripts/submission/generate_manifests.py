...
def main():
    ...
    exp_root = args.experiment_root if args.experiment_root else (Path(os.environ.get('CAN_EXPERIMENT_ROOT')) if os.environ.get('CAN_EXPERIMENT_ROOT') else PROJECT_ROOT / 'experimentruns')
