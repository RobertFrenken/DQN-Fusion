...
class GATPipeline:
    ...
    def _print_error_statistics(self, errors_normal, errors_attack, edge_errors_normal, 
        ...
        if structural_errors_normal and structural_errors_attack:
            plot_edge_error_hist(structural_errors_normal, structural_errors_attack, 
                                np.percentile(structural_errors_normal, 95), 
                                save_path="structural_error_hist.png", 
                                title="Structural Feature Distribution")
