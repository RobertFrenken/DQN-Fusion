...
#SBATCH --output=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/dqn_hcrl_sa_fusion_20260125_234059.out
#SBATCH --error=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/dqn_hcrl_sa_fusion_20260125_234059.err
#SBATCH --chdir=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT
#SBATCH --dependency=afterok:43961966
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "Check error log: /users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/dqn_hcrl_sa_fusion_20260125_234059.err"
fi
echo "End time: $(date)"
echo "=================================================================="
