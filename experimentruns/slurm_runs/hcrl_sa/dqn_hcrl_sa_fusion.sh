#!/bin/bash
#SBATCH --job-name=dqn_hcrl_sa_fusion
...
#SBATCH --output=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/hcrl_sa/dqn_hcrl_sa_fusion_20260126_113003.out
#SBATCH --error=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/hcrl_sa/dqn_hcrl_sa_fusion_20260126_113003.err
#SBATCH --chdir=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT
#SBATCH --dependency=afterok:43964227
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo "Check error log: /users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/hcrl_sa/dqn_hcrl_sa_fusion_20260126_113003.err"
fi
echo "End time: $(date)"
echo "=================================================================="
