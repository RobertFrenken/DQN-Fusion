...
#SBATCH --output=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/set_01/fusion/fusion_set_01_20260124_205541.log
#SBATCH --error=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/set_01/fusion/fusion_set_01_20260124_205541.err
...
echo "Running: python train_with_hydra_zen.py --preset=fusion_set_01 --data-path /users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/data/automotive/set_01"
python train_with_hydra_zen.py --preset fusion_set_01 --data-path /users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/data/automotive/set_01
...
python src/training/train_with_hydra_zen.py --preset fusion_set_01 --data-path /users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/data/automotive/set_01
...
if [ $TRAIN_EXIT_CODE -eq 0 ]; then
    ...
    echo "Check logs: /users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/set_01/fusion/fusion_set_01_20260124_205541.err"
    echo ""
    exit 1
fi
