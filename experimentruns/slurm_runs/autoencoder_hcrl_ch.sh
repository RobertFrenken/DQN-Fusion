#!/bin/bash
#SBATCH --job-name=autoencoder_hcrl_ch
...
#SBATCH --output=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/hcrl_ch/autoencoder/autoencoder_hcrl_ch_20260124_121937.log
#SBATCH --error=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/hcrl_ch/autoencoder/autoencoder_hcrl_ch_20260124_121937.err
...
echo "Running: python train_with_hydra_zen.py --preset=autoencoder_hcrl_ch --data-path /users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/data/automotive/hcrl_ch"
python train_with_hydra_zen.py --preset autoencoder_hcrl_ch --data-path /users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/data/automotive/hcrl_ch
...
python src/training/train_with_hydra_zen.py --preset autoencoder_hcrl_ch --data-path /users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/data/automotive/hcrl_ch
...
if [ $TRAIN_EXIT_CODE -eq 0 ]; then
    ...
    echo "Check logs: /users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/hcrl_ch/autoencoder/autoencoder_hcrl_ch_20260124_121937.err"
    echo ""
    exit 1
fi
