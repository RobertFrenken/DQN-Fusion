#!/bin/bash
#SBATCH --job-name=automotive_hcrl_ch_unsupervised_vgae_teacher_no_au
...
#SBATCH --output=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/autoencoder_hcrl_ch_20260124_030742.log
#SBATCH --error=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/autoencoder_hcrl_ch_20260124_030742.err
...
if [ $TRAIN_EXIT_CODE -eq 0 ]; then
    ...
    echo "Check logs: /users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/autoencoder_hcrl_ch_20260124_030742.err"
    echo ""
    exit 1
fi
