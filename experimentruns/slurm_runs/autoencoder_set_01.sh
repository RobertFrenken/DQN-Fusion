...
#SBATCH --output=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/set_01/autoencoder/autoencoder_set_01_20260124_121922.log
#SBATCH --error=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/set_01/autoencoder/autoencoder_set_01_20260124_121922.err
...
if [ $TRAIN_EXIT_CODE -eq 0 ]; then
    ...
    echo "Check logs: /users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/set_01/autoencoder/autoencoder_set_01_20260124_121922.err"
    echo ""
    exit 1
fi
