...
#SBATCH --output=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/hcrl_sa/curriculum_hcrl_sa_20260124_205513.log
#SBATCH --error=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/hcrl_sa/curriculum_hcrl_sa_20260124_205513.err
...
python src/training/train_with_hydra_zen.py --preset curriculum_hcrl_sa --data-path /users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/data/automotive/hcrl_sa
...
if [ $TRAIN_EXIT_CODE -eq 0 ]; then
    ...
    echo "Check logs: /users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/hcrl_sa/curriculum_hcrl_sa_20260124_205513.err"
    echo ""
    exit 1
fi
