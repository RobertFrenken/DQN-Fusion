#!/bin/bash
#SBATCH --job-name=automotive_hcrl_sa_unsupervised_vgae_teacher_no_au
...
#SBATCH --output=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/autoencoder_hcrl_sa_20260124_003520.log
#SBATCH --error=/users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/autoencoder_hcrl_sa_20260124_003520.err
...
if [ $TRAIN_EXIT_CODE -eq 0 ]; then
    ...
    echo "Check logs: /users/PAS2022/rf15/CAN-Graph-Test/KD-GAT/experimentruns/slurm_runs/autoencoder_hcrl_sa_20260124_003520.err"
    echo ""
    exit 1
fi
